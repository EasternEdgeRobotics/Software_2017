...
public class DataMediationTest {
    private static final long TIME_STEP = 100;

    @Test
    public final void doesInitialValuesWhenStopped() {
        final TestScheduler scheduler = new TestScheduler();
        final DataMediation manager = new DataMediation(TIME_STEP, TimeUnit.MILLISECONDS, scheduler);
        ...
        manager.mediate(source, initial, consumer);
